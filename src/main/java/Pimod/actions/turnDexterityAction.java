...
public class turnDexterityAction extends AbstractGameAction {
    private final AbstractCreature c;

    public turnDexterityAction(AbstractCreature c) {
        this.c = c;
        this.duration = 0.5F;
    }
        ...
        if(c.hasPower("experiencePower")){
            ...
            while(var1.hasNext()) {
                ...
                if (p.ID.equals("experiencePower")&&p.amount>4) {
                    ...
                    this.addToBot(new ApplyPowerAction(c,c,new DexterityPower(c,energyNum)));
