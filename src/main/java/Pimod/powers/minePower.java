...
public class minePower extends AbstractPower {
    public  static final String POWER_ID="minePower";
    private  static  final PowerStrings powerStrings;
    public static final String NAME;
    public static final String[] DESCRIPTIONS;

    public minePower(AbstractCreature owner, int amount){
    ...
    public void atStartOfTurn() {
        ...
        this.addToBot(new MakeTempCardInHandAction(getRandomMineralCard(),1));
    }
