...
public class getYashiya extends AbstractCard {
    public static final String ID = "getYashiya";
    ...
    public void onChoseThisOption() {
        ...
        if(!p.hasPower("yashiyaPower")){
            this.addToTop(new ApplyPowerAction(p,p,new yashiyaPower(p)));}
    }
