...
import Pimod.powers.trashCanPower;
...
public class trashCan extends AbstractCard {
    public static final String ID = "trashCan";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new trashCanPower(p, magicNumber), magicNumber));
    }
