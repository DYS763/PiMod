...
public class allChoice extends AbstractCard {
    ...
    public allChoice() {
        super("allChoice", cardStrings.NAME, "red/power/demon_form", 3, cardStrings.DESCRIPTION, CardType.POWER, AbstractCardEnum.PI_COLOR, CardRarity.RARE, CardTarget.NONE);
