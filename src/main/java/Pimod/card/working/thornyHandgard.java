...
public class thornyHandgard extends AbstractCard {
    public static final String ID = "thornyHandgard";
    private static final CardStrings cardStrings;
    private static final int COST = 1;

    public thornyHandgard() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new thornyHandgardPower(p, magicNumber), magicNumber));
