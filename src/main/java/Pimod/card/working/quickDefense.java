...
import Pimod.actions.quickDefenseAction;
...
public class quickDefense extends CustomCard{

    public static final String ID = "quickDefense";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new quickDefenseAction(p));

    }

    public AbstractCard makeCopy() {
        return new quickDefense();
    }
