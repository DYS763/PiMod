...
import Pimod.powers.polishPower;
...
public class polish extends AbstractCard {
    public static final String ID = "polish";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new polishPower(p, magicNumber), magicNumber));
